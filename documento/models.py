...
from backend.correspondencia.models import Correspondencia

# Create your models here.
class Documento(models.Model):
    correspondencia = models.ForeignKey(Correspondencia, on_delete=models.CASCADE, related_name='documentos')
